...
{
	if (FNV1A::Hash(I::VGuiPanel->GetName(vgui_panel)) != FNV1A::HashConst("MatSystemTopPanel") || Vars::Visuals::UI::CleanScreenshots.Value && I::EngineClient->IsTakingScreenshot())
