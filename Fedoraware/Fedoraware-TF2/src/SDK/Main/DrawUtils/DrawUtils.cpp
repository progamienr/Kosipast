...
void CDraw::RemakeFonts()
{
	...
	m_Fonts[FONT_NAME] = { 0x0, Vars::Fonts::FONT_NAME::szName.Value.c_str(), Vars::Fonts::FONT_NAME::nTall.Value, Vars::Fonts::FONT_NAME::nWeight.Value, Vars::Fonts::FONT_NAME::nFlags.Value };
